...
import { backlogListUrl, sprintsListUrl } from "../../../shared/routing/workspaceNavUrls.js";
        ...
        actions={
          !loading && project ? (
            <div className={wave1.navRow}>
              ...
              <Button variant="secondary" type="button" onClick={() => navigate(sprintsListUrl(project.id))}>
                Sprints
              </Button>
