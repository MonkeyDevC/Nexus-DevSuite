...
import { mapProjectStatusToDsBadgeVariant } from "../../pages/wave1DsMappers.js";
...
export default function ProjectViewTab({
  ...
  const teamLabel =
    typeof projectData.team_member_count === "number"
      ...
      : "—";
  const numberLabel = Number.isFinite(projectData.number) ? String(projectData.number) : "—";
  const internalIdDisplay = numberLabel !== "—" ? `#${numberLabel}` : internalIdAbbrev;
