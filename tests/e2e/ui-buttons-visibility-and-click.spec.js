...
test.describe("UI audit: button visibility and trial click on protected routes", () => {
  test("visible actionable buttons on dashboard, projects, admin, and settings pass checks", async ({ page, request }) => {
