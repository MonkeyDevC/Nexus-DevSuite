...
const { getBaseUrl, getApiBaseUrl } = require("./support/constants.js");
...
test.describe("Auth and HTTP: legacy bridge, login contract, refresh queue", () => {
  test("API login shape, protected shell, bridge envelope, refresh single-flight, and BRIDGE_MISSING", async ({
    page,
    request,
  }) => {
    ...
    await test.info().attach("auth-http-bridge-results.json", {
