/**
 * Incidents: flujo React + API (MASTER) con transiciones y cierre con RCA.
 */
...
test.describe("Incidents: create, transition, close with RCA, and list filtering", () => {
  test("user creates incident, moves through states, closes with RCA, and list reflects filters", async ({
    page,
    request,
  }) => {
